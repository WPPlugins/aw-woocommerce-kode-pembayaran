...
Plugin URI: http://www.agenwebsite.com/products/woocommerce-kode-pembayaran
...
class wc_kode_pembayaran{
    ...
    public function links($actions, $plugin_file, $plugin_data, $context){
        ...
        array_unshift($actions, '<a href="http://agenwebsite.com/products/woocommerce-kode-pembayaran" target="new">' . __( 'Buy Full Version', 'agenwebsite' ) . '</a>');
        return $actions;
    }
